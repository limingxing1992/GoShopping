//
//  DayBaicaiTableViewController.m
//  WorthToBuy
//
...
@interface DayBaicaiTableViewController ()
...
@implementation DayBaicaiTableViewController
...
{
    return [AppStore sharedInstance].dayBaicaiData.count;
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell updateWithModel:[AppStore sharedInstance].dayBaicaiData[indexPath.row]];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    AppModel *model = [AppStore sharedInstance].dayBaicaiData[indexPath.row];
...
-(void)addRefresh
{
    ...
    self.tableView.footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        ...
        weakself.lastTime = [[[AppStore sharedInstance].dayBaicaiData lastObject] article_date];
...
-(void)request
{
    ...
    [MMProgressHUD showDeterminateProgressWithTitle:@"加载中" status:@"loading"];
        ...
        if (self.lastTime == nil) {
            url = kDayBaicaiClearUrl;
        }else{
            url = [NSString stringWithFormat:kDayBaicaiUrl,self.lastTime];
        }
        ...
        } withBool:self.isRefreshing Type:kDayBaicaiType];
